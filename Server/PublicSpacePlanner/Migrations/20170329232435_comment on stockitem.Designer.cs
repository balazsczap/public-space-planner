...
namespace PublicSpacePlanner.Migrations
{
    ...
    [Migration("20170329232435_comment on stockitem")]
    partial class commentonstockitem
    {
            ...
            modelBuilder.Entity("PublicSpacePlanner.Data.Models.Comment", b =>
                {
                    ...
                    b.HasOne("PublicSpacePlanner.Data.Models.StockItem", "OnItem")
                        .WithMany("Comments")
                        .HasForeignKey("OnItemId");
                });
